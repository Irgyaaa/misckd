...
<head>
    ...
    <title>Login - Madrasah Ibtidaiyah Cikadongdong</title>
    ...
    <style>
        ...
        p {
            text-align: center;
            color: #228B22;
            /* Changed color for the paragraph */
            font-weight: 500;
            /* Added a bit more weight for emphasis */
        }
...
<body>
    <div class="container">
        ...
        <main class="main-content">
            <h3>Madrasah Ibtidaiyah Cikadongdong</h3>
            <h5>Silahkan masuk untuk melanjutkan</h5> <!-- Text color changed here -->
        ...
        <footer class="footer">
            <p>&copy; 2025 Madrasah Ibtidaiyah Cikadongdong.</p>
        </footer>
    </div>
